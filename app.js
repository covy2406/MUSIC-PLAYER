    ...
    songs: [
        {
            ...
            singer: 'Thoi Tu Cach',
            path: '../CODE_MUSIC_PLAYER/assets/music/Nho-Ma-Khong-The-Noi-Thoi-Tu-Cach.mp3',
            image: '../CODE_MUSIC_PLAYER/assets/image/Kim-seon-ho.jpg',
        },
        {
            name: 'Breath',
            singer: 'Sam Kim',
            path: '../CODE_MUSIC_PLAYER/assets/music/Breath-Sam-Kim.mp3',
            image: '../CODE_MUSIC_PLAYER/assets/image/suzy-long-hair.jpg',
        },
        {
            name: 'Ending Scene',
            singer: 'IU',
            path: '../CODE_MUSIC_PLAYER/assets/music/Ending-Scene-IU.mp3',
            image: '../CODE_MUSIC_PLAYER/assets/image/IU.jpg',
        },
        {
            name: 'Say you do',
            singer: 'Tien Tien',
            path: '../CODE_MUSIC_PLAYER/assets/music/Say-You-Do-Tien-Tien.mp3',
            image: '../CODE_MUSIC_PLAYER/assets/image/cape_suzy.jpg',
        },
        {
            name: 'If it is you',
            singer: 'Rosie',
            path: '../CODE_MUSIC_PLAYER/assets/music/If-It-Is-You-Rose-BLACKPINK.mp3',
            image: '../CODE_MUSIC_PLAYER/assets/image/Rosie.jpg',
        },
        {
            name: 'Bad Boy',
            singer: 'RedVelvet',
            path: '../CODE_MUSIC_PLAYER/assets/music/Bad-Boy-Red-Velvet.mp3',
            image: '../CODE_MUSIC_PLAYER/assets/image/seon-ho-hometown.jpg',
        },

        {
            name: 'Tinh yeu cham tre',
            singer: 'Monstar',
            path: '../CODE_MUSIC_PLAYER/assets/music/tinh-yeu-cham-tre-MONSTAR.mp3',
            image: '../CODE_MUSIC_PLAYER/assets/image/seon-ho-cute.jpg',
        }
    ],
